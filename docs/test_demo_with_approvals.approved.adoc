...
include::test_demo_with_approvals.TestSubClassDemo.approved.adoc[leveloffset=+1]
include::test_demo_with_approvals.TestSubClassDemo.test_chapter_on_a_subclass.approved.adoc[leveloffset=+2]
include::test_demo_with_approvals.TestSubClassDemo.test_second_chapter_on_a_subclass.approved.adoc[leveloffset=+2]
